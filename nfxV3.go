// Copyright © 2023-2026 Peter Haag peter@people.ops-trust.net
// All rights reserved.
//
// Use of this source code is governed by the license that can be
// found in the LICENSE file.

// Legacy V3 record definitions used by the nfdump 1.7.x compatibility API.
// They are deliberately expressed in Go rather than generated through cgo, so
// both the V1/V2/V3 and V3/V4 readers build from one self-contained source
// tree. Keep their field layout in sync with nfdump 1.7.x when changing the
// legacy API.
